// src/data/articles/article-21.ts
...
5.     Providers of medical goods and services (physicians, surgeons, hospitals, clinics, pharmaceutical manufacturers, medical-device companies, diagnostic laboratories, and any other entity billing for health-related products or services) are likewise subject to strict oversight by an independent Medical Price and Practice Board. Prohibited practices include, but are not limited to:
      ...
      Violation by any licensed provider or corporate officer shall result in permanent loss of licence to practise or sell in the Dominion, personal fines of up to ten times the illicit gain, and imprisonment for repeat or egregious offences.
...
7.     Generic and off-patent pharmaceuticals, basic medical devices, and common surgical procedures shall be subject to reference pricing based on the lowest responsible international benchmark; no provider or manufacturer may charge citizens of the Dominion more than 110 % of that benchmark.
