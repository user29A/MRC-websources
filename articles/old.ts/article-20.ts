// src/data/articles/article-20.ts
import type { Article } from "./types";

export const article20: Article = {
  number: 20,
  title: "Fiscal and Monetary Sovereignty",
  content: `
The experience of centuries proves that the private or foreign control of a nation’s money and credit is the most effective and least visible method of conquering a people. Nations that surrender this power are sooner or later dispossessed, impoverished, and replaced. The Meritocratic Dominion of Canada shall never repeat that fatal error.

1.     The Bank of Canada is hereby affirmed as a 100 % publicly owned institution reporting directly to the House of the Dominion. Its sole mandate is the preservation of the purchasing power of the currency, full employment of Canadian citizens, and the financing of legitimate public infrastructure and defence at zero or near-zero interest. All profits of the Bank of Canada belong exclusively to the Canadian people and shall be paid annually into general revenue or the sovereign wealth fund created under Article 22.
...
5.     No central-bank digital currency, programmable money, social-credit system, or any form of currency that can restrict, track, or condition individual spending shall ever be created, tested, piloted, or tolerated within the Dominion under any pretext whatsoever. Violation is high treason.
...
8.     Selection and Accountability of the Governor and Directors of the Bank of Canada
      a)     The Governor and the eight Directors shall be nominated by a special parliamentary committee and confirmed by a two-thirds vote of the House of the Dominion for a single non-renewable twelve-year term.
