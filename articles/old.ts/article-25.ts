// src/data/articles/article-25.ts
import type { Article } from "./types";

export const article25: Article = {
  number: 25,
  title: "Environmental and Resource Sovereignty",
  content: `
