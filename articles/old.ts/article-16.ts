// src/data/articles/article-16.ts
import type { Article } from "./types";

export const article16: Article = {
  number: 16,
  title: "Citizenship and the Franchise",
  content: `
The right to choose the government of the Dominion and to initiate or approve binding referenda is the supreme political act of sovereignty. It belongs exclusively to citizens who bear the burdens and benefits of membership in the nation.

1.     Only citizens of the Dominion of Canada, as defined in Article 9, aged 25 years or more, may vote in any election or referendum, national, provincial, or municipal. Non-citizens, including permanent residents, are permanently and irrevocably excluded from the franchise.
