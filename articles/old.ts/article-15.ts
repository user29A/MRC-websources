// src/data/articles/article-15.ts
import type { Article } from "./types";

export const article15: Article = {
  number: 15,
  title: "The Judiciary and Public Safety",
  content: `
...
6.     The death penalty is restored for premeditated murder, child rape, high treason, and for extreme, provably intentional financial, medical, religious, or scientific fraud that directly causes widespread death or irreversible ruin, upon unanimous jury verdict beyond reasonable doubt.

7.     All executions shall be carried out solely by firing squad within seven days of final sentencing.

8.     The criminal justice system of the Dominion exists first to protect the innocent and second to restore the offender to lawful life wherever this is compatible with public safety.
